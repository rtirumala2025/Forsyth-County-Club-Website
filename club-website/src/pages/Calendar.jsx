...
const Calendar = () => {
  ...
  // Sample events data - in a real app, this would come from the events page
                ...
                <div className="space-y-3">
                  <button
                    ...
                    className={`w-full flex items-center px-3 py-2 rounded-lg transition-colors ${
                      viewMode === 'month' ? 'bg-blue-100 text-blue-700 border border-blue-200' : 'bg-gray-50 text-gray-700 hover:bg-gray-100'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`w-full flex items-center px-3 py-2 rounded-lg transition-colors ${
                      viewMode === 'week' ? 'bg-blue-100 text-blue-700 border border-blue-200' : 'bg-gray-50 text-gray-700 hover:bg-gray-100'
                    }`}
                  >
                  ...
                  {days.map((day, index) => {
                    ...
                    return (
                      <button
                        ...
                        className={`min-h-[120px] p-2 text-left border border-gray-100 hover:border-blue-300 transition-all duration-200 ${
