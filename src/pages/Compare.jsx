...
import { ChevronLeft, Search, Users, Calendar, MapPin, Star, X, ChevronDown, Filter, Grid3X3, List } from 'lucide-react';
              ...
              <div className="relative">
                ...
                {schoolDropdownOpen && createPortal(
                  <>
                    ...
                    />
                    <div 
                      className="fixed w-80 bg-white border border-gray-300 rounded-lg shadow-xl z-[9999] max-h-60 overflow-y-auto"
                      style={{
