...
describe('AuthGuard', () => {
  ...
  it('should redirect to login when user is not authenticated', async () => {
    (useAuthState as any).mockReturnValue([null, false, null]);
  ...
  it('should show loading state while checking authentication', () => {
    (useAuthState as any).mockReturnValue([null, true, null]);
  ...
  it('should show error state when authentication fails', async () => {
    (useAuthState as any).mockReturnValue([null, false, new Error('Auth failed')]);
