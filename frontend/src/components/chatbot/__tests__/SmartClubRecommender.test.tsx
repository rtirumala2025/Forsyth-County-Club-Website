...
describe('SmartClubRecommender', () => {
  beforeEach(() => {
    ...
    (smartClubService.processUserInputSmart as any).mockResolvedValue({
    ...
    (smartClubService.generateSmartBotResponse as any).mockReturnValue({
  ...
  describe('Error Handling', () => {
    ...
    test('shows loading state during processing', async () => {
      ...
      (smartClubService.processUserInputSmart as any).mockImplementation(() =>
